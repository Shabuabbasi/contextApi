...
import New from "../assets/img/products/n1.jpg";
...
const NewArrivals = () => {
  ...
  return (
    <section className="bg-gray-100 px-4 py-12 md:px-10 md:py-20">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">New Arrivals</h2>
          <p className="text-gray-600 dark:text-gray-300">
            Summer Collection 50% OFF
          </p>
        </div>
